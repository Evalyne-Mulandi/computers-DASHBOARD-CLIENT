        ...
        <transition name="fade">
          ...
          >
            <div class="py-3 px-4 text-sm text-gray-900 dark:text-gray-200">
              <div>Logged As</div>
              <div class="font-medium truncate">Evah</div>
            </div>
            <ul
            ...
            <router-link
              ...
              <li>
                <a href="#" class="block py-2 px-4 hover:bg-primary hover:text-white"
                  >Settings</a
                >
              </li>
              <li>
                <a href="https://github.com/Evalyne-Mulandi" class="block py-2 px-4 hover:bg-primary hover:text-white"
                  >Github</a
                >
              </li>
            </ul>
