<template>
  ...
  <nav class="sidebar bg-white dark:bg-gray-800">
    ...
    <div class="sidebar-head p-4">
      <router-link to="/" exact>
        <h2 class="text-2xl font-normal  text-gray-800 dark:text-gray-500" translate="no">
          Online selling system<span class="text-primary">.</span>
          <span
    ...
    <div class="sidebar-list p-4 mt-4">
      ...
      <div class="wrap-item mt-4 dark:text-gray-500">
        ...
        <div class="item mt-3">
          <menu-accordion>
            ...
            <template v-slot:title> Computers</template>
        ...
        <div class="item mt-3">
          <menu-accordion>
            ...
            <template v-slot:title> Buyers </template>
            <template v-slot:content>
              <button
      ...
      <p class="font-medium text-gray-400 mt-4 dark:text-gray-600">Settings</p>
      ...
      <div class="item mt-3">
        <menu-accordion>
          ...
          <template v-slot:title> User profile </template>
      ...
      <div class="item mt-3">
        <menu-accordion>
          ...
          <template v-slot:title> Reset passsword </template>
          <template v-slot:content> </template>
        </menu-accordion>
      </div>
      <div class="item mt-3">
